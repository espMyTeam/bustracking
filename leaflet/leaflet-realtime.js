...
!function (name, context, definition) {
  ...
  var win = window
    ...
    , defaultHeaders = {
        ...
        ,"Access-Control-Allow-Methods": "REQUEST,GET,HEAD,OPTIONS,POST,PUT"
        ,"Access-Control-Allow-Headers":"Content-Type, Access-Control-Allow-Headers,Access-Control-Allow-Origin, Authorization, X-Requested-With, Access-Control-Allow-Methods, Access-Control-Allow-Credentials"
      }
