...
<!-- features -->
	<div id="features" class="features">
		<div class="container">
			...
			<div class="services-grids">
				<div class="col-md-12 col-xs-12 services-grid-left">
					<!--div class="col-xs-8 services-grid-left1">
						
					</div-->
					
					<!--div class="col-xs-4 services-grid-left2">
						<h4>Free Images</h4>
						<p>
	...
	<div class="map">
		<div class="container">
				<div class="col-md-12 col-xs-12" style="min-height:100%; min-width:100%;">
